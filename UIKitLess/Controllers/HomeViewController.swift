...
struct RMLinkStorage {
    ...
    var userStories: [Stories] = [
        .init(avatarName: "engine", loginName: "Запуск"),
        .init(avatarName: "moon", loginName: "Луна"),
        .init(avatarName: "cosmonaut", loginName: "Космона..."),
        .init(avatarName: "space", loginName: "Космос"),
        .init(avatarName: "engine", loginName: "Запуск")
    ]
